function changeCodeBlock() {
  for (var e = document.getElementsByTagName("pre"), t = 0; t < e.length; t++) {
    var n = e[t],
      i = n.firstChild;
    if (i && "CODE" === i.tagName)
      if (i.classList.contains("language-motoko"))
        n.classList.add("motoko"), appendRun(n, extractConfig(n));
  }
}
function extractConfig(e) {
  ...
  for (var i = [], o = null, r = 0; r < t.classList.length; r++) {
    ...
    if (l.startsWith("include"))
      for (var s = l.split("_"), a = 1; a < s.length; a++) i.push(s[a]);
...
function appendRun(s, a) {
  if ((a.name && Motoko.saveFile(a.name, s.firstChild.innerText), !a.noRepl)) {
    ...
    a.lineNumber ? (s.style = "padding-left: calc(35px)") : (s.style = ""),
      ...
      n.addEventListener("click", function () {
        ...
        if ((Motoko.saveFile(o, i), a.hook)) {
          ...
          if ("function" != typeof r)
            throw new Error(a.hook + " is not a function");
          e = r.apply(null, [n, i]);
        } else {
        ...
        (d.innerHTML = ""),
          e.stderr &&
            (((t = document.createElement("pre")).style = "color:red"),
            (t.innerText = e.stderr),
            d.appendChild(t));
        e.stdout &&
          (((t = document.createElement("pre")).style = "color:green"),
          (t.innerText = e.stdout),
          d.appendChild(t));
        highlightCode(s);
      }),
      a.isRun && n.click();
